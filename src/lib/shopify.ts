...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'aura-jewels-u0ag8.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = 'dcb24ce3a6f257ed193b1c5eea8d0b72';
...
export async function verifyCart(cartId: string): Promise<boolean> {
  const data = await storefrontApiRequest(CART_QUERY, { id: cartId });
  if (!data) return true; // API error, preserve cart
